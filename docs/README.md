...
| `remote-control-design.md` | **Design.** | How the cloud VM drives the Windows machine, and why a git queue rather than a service. Read before changing the ops layer. |
