...
| [`docs/remote-control-design.md`](docs/remote-control-design.md) | the remote-control design and its trust boundary |
| [`docs/remote-control-setup.md`](docs/remote-control-setup.md) | installing the queue, once per machine |
